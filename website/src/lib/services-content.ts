...
export const SERVICES: ServiceContent[] = [
  ...
  },
  {
    ...
    callout:
      'Most automation projects fail for one reason: the vendor built to a template instead of to your actual process. We scope every engagement around the systems you already run, whether that is Zoho, WhatsApp, a spreadsheet, or something you built in-house.',
    sections: [
      {
        heading: 'Built around your business, not a template',
        level: 2,
        body: [
          'We work with businesses across Dubai, Abu Dhabi and the wider UAE in retail, real estate, logistics, hospitality, healthcare, finance and professional services. The starting point is always the same question: what is your team still doing by hand that a workflow could handle instead?',
          'Most projects start with one workflow built fast on n8n, usually paying for itself within weeks. From there we extend into AI agents, document processing, and deeper system integration as the first build proves out.',
        ],
      },
      {
        heading: 'Self-hosted, if your data needs to stay put',
        level: 2,
        body: [
          'Some businesses need their data to stay inside a specific environment or region. For those teams we deploy self-hosted, with role-based access and a full audit trail, instead of on a shared cloud platform. It is an option we scope in when it is needed, not something every client has to pay for.',
        ],
      },
    ],
    process: [
      { title: 'Free automation audit', body: 'We look at how your team actually works today and find where automation saves the most time, whatever tools you currently run.' },
      { title: 'Scope and fixed price', body: 'We agree the deliverables, the ROI target, and a fixed price in AED or USD before any work starts.' },
      { title: 'Build on your stack', body: 'We build and integrate with the systems you already use. Self-hosted in your own environment if your team needs that.' },
      { title: 'Deploy and measure', body: 'You get training and reporting against the ROI target we agreed at the start, not just a handoff.' },
    ],
    whyCustom: [
    ...
    included: [
      ...
      'Workflow automation on n8n',
      'AI agents for customer replies and lead handling',
    ...
    faqs: [
      { q: 'Do you only work with regulated industries like finance and legal?', a: 'No. Most of our Dubai and UAE work is for retail, real estate, logistics, hospitality and other everyday businesses. Self-hosted deployment is an option for finance, legal and healthcare teams that specifically need it, not a requirement for everyone.' },
      { q: 'Do you work with companies based in Dubai and Abu Dhabi?', a: 'Yes, we deliver for clients across Dubai, Abu Dhabi and the wider UAE and GCC. Our working hours already overlap with yours, and everything we build is documented so your team is never dependent on us to run it.' },
      { q: 'Can you work with the tools we already use, like Zoho, HubSpot or WhatsApp?', a: 'Yes. We build around whatever you already run instead of asking you to switch platforms first. That includes your CRM, WhatsApp Business API, accounting software, or a system you built in-house.' },
      { q: 'Can our data stay inside the UAE?', a: 'Yes, if you need it to. We can self-host on infrastructure you control, so you choose where your data sits. This gets settled while we scope the project, not assumed by default.' },
      { q: 'How long does an engagement take?', a: 'A focused workflow usually goes live in two to six weeks. A larger AI system typically takes a couple of months. Either way, you get a written scope and timeline before any work begins.' },
      { q: 'What does it cost?', a: `Engagements are fixed price and scoped to the outcome, quoted in AED or USD. ${GUARANTEE} Book a discovery call for a clear price and ROI estimate.` },
    ],
    related: ['n8n-automation-services', 'sales-revenue-automation', 'document-processing-automation', 'financial-services-automation', 'us-ai-automation-agency'],
  },
  ...
  {
    // Metadata + JSON-LD source only. StartupGrowthPage.tsx (rendered via this
    // slug's page.tsx) is a fully bespoke, independent build — it does not read
    // sections/process/faqs/etc. from this registry. Kept minimal deliberately;
    // do not re-expand this entry, expand the actual page components instead.
    slug: 'ai-growth-systems-for-startups',
    metaTitle: 'AI Growth Systems for Startups | Chronexa',
    metaDescription:
      'A framework for growth-stage startups to scale output without scaling headcount in lockstep. Find your Leverage Ratio, see the Headcount Tax, and book a systems audit.',
    h1: 'AI Growth Systems for Startups',
    heroSub:
      'A framework for growth-stage Indian startups (Seed+ through Series B) to scale output without scaling headcount in lockstep — built around the Leverage Line, Chronexa\'s framework for telling systems-scaled companies apart from the 1:1 Trap.',
    answer:
      'AI Growth Systems are custom-built automations that take on the repeatable share of a growth-stage startup\'s work — so output keeps compounding without headcount growing at the same rate. Chronexa builds them into the tools you already run, at a fixed price scoped after a free discovery call.',
    serviceName: 'AI Growth Systems for Startups',
    serviceType: 'Custom AI automation for growth-stage startups',
    schemaDescription:
      'Custom AI Growth Systems for growth-stage startups, built around the Leverage Line framework — helping founders scale output without scaling headcount in lockstep.',
    roi: [],
    sections: [],
    process: [],
    whyCustom: [],
