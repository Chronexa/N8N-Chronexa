...
export const SERVICES: ServiceContent[] = [
  ...
  },
  {
    ...
    metaDescription:
      'AI automation agency for Dubai & UAE businesses of any size or industry — workflow automation, AI agents & document processing, fixed-price with a 90-day ROI guarantee.',
    h1: 'AI Automation Agency for Dubai & UAE Businesses',
    answer:
      'Chronexa is an AI automation agency working with businesses across Dubai, Abu Dhabi and the wider UAE — from retail and real estate to finance, legal, healthcare and logistics. We build workflow automation, AI agents, document processing and system integrations, scoped to your business and fixed-price, backed by a 90-day ROI guarantee. For teams with stricter data-residency needs, we also offer self-hosted deployment inside your own environment.',
    heroSub:
      'Workflow automation, AI agents and document processing for Dubai & UAE businesses in any industry — scoped to your business, fixed-price, with a 90-day ROI guarantee.',
    ...
    sections: [
      {
        heading: 'AI automation for any Dubai or UAE business',
        level: 2,
        body: [
          'We work across industries — retail and e-commerce, real estate, logistics and trading, hospitality, healthcare, professional services, finance and legal. If your team is still doing something by hand that a workflow could handle — chasing leads, re-typing data between systems, replying to the same WhatsApp questions, compiling a report every week — that is exactly the kind of problem we solve, regardless of what sector you’re in.',
          'The build ranges from a single fast n8n workflow that pays for itself in weeks, up to a full custom AI system — agentic workflows, RAG knowledge engines, document intelligence — for teams with more complex or higher-stakes processes. We scope to the problem, not to a fixed package.',
        ],
      },
      {
        heading: 'Self-hosted and audit-ready, for teams that need it',
        level: 2,
        body: [
          'For finance, legal, healthcare and other regulated teams, we also deploy inside your own environment — self-hosted, in-region if required, with role-based access and a full audit trail — so sensitive data never has to leave your control. This is an option we scope in when it matters, not a requirement we impose on every client.',
        ],
      },
      {
        heading: 'Workflow automation and n8n as the fast on-ramp',
        level: 3,
        body: [
          'Most engagements start with a high-volume, lower-risk workflow — lead routing, document intake, WhatsApp or CRM integration, reporting — built fast on n8n that you own outright, rather than rented per task on Zapier or Make. It is the pragmatic starting point for most Dubai and Abu Dhabi businesses, proves out the ROI, and often expands from there.',
        ],
      },
    ],
    process: [
      { title: 'Free automation audit', body: 'We review your workflows and identify where automation saves the most time and cost — whatever tools you currently run.' },
      ...
      { title: 'Deploy & measure', body: 'Go live with training and reporting against the ROI targets agreed up front.' },
    ],
    whyCustom: [
      'Built for any industry — not limited to a single vertical or a fixed package of services.',
      'Self-hosted, audit-ready deployment available for finance, legal and other regulated teams that need it.',
      'Fixed-price and outcome-scoped, with ROI agreed before the build and a 90-day guarantee.',
      'You own the workflows and integrations we build — not another per-seat subscription.',
    ],
    included: [
      'Free AI & workflow automation audit',
      'Workflow automation (n8n) & AI agents',
      'Document processing & data extraction',
      'CRM, WhatsApp & system integrations',
      'Self-hosted deployment for regulated teams',
      'Security, access control & audit trails where needed',
      '90-day ROI guarantee',
      'Ongoing optimization & support',
    ],
    faqs: [
      { q: 'Do you only work with regulated industries like finance and legal?', a: 'No. Most of our Dubai and UAE work is for retail, real estate, logistics, hospitality and other everyday businesses — workflow automation, AI agents, CRM and WhatsApp integration. Self-hosted, audit-ready deployment is an option we add for finance, legal and healthcare teams that specifically need it, not a requirement for everyone.' },
      ...
      { q: 'Can you work with the tools we already use — Zoho, HubSpot, WhatsApp, our own systems?', a: 'Yes. We build around whatever you already run rather than asking you to switch platforms first — CRM, ERP, WhatsApp Business API, spreadsheets, or a homegrown system.' },
      { q: 'Can our data stay inside the UAE?', a: 'Yes, if you need it to. We can self-host on infrastructure you control, so you choose the region your data sits in. This is settled during scoping, not assumed by default.' },
      { q: 'How long does an engagement take?', a: 'A focused workflow typically goes live in 2–6 weeks; a larger custom AI system usually runs a couple of months. You get a written scope and timeline before any build begins.' },
